...
def validate_fastqSE(file_path):
    ...
    print(f"Validation successful for input files {file_path}. ")


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Validate and compare single FASTQ files.")
    parser.add_argument("--input", required=True, help="Path to the FASTQ file.")
   
    
    args = parser.parse_args()
    
    try:
        validate_fastqSE(args.input)
